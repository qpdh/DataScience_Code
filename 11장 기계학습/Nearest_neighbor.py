...
for k in [1, 3, 5]:
    ...
    for location, actual_language in cities:
        ...
        cities_lan = [lan for _, lan in other_cities]
        ...
        if clf_predited_language[0] != predicted_language:
            print(k,location,*clf_predited_language, predicted_language,actual_language)
...
#
#
#     print(k, "neighbot[%s]:" % (num_correct), "correct out of", len(cities))
#
# clasifiy_and_plot_grid(3)
